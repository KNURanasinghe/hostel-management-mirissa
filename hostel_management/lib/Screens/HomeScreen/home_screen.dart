...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  Widget _buildTabBar() {
    return Container(
      ...
      child: Row(
        children: [
          // User logo - hide when search is expanded
          UserLogo().animate().scale(duration: 100.ms).fadeIn(delay: 100.ms),
          if (isSearchExpanded)
          ...
          // Tab buttons - hide when search is expanded
          if (!isSearchExpanded) ...[
            // Activities tab
            GestureDetector(
              onTap: () => selectTab(0),
          ...
          // Close button when search is expanded
          if (isSearchExpanded) SizedBox(width: 5),
              ...
              child:
                  isSearchExpanded
                      ? Icon(
                        ...
                        size: 24,
                      ).animate().rotate(begin: 0, end: 0.5, duration: 300.ms)
                      : Image(
                            image: AssetImage('assets/search.png'),
                            width: 24,
                            height: 24,
  ...
  Widget _buildHostelsGrid() {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final hostelLogo = hostel['images'] as List<dynamic>?;

        final hostelImageUrl =
            (hostelLogo != null && hostelLogo.isNotEmpty)
                ? hostelLogo[0]
        ...
        return HostelCard(
              ...
              hostelImg: hostelImageUrl, // keep this as local asset for now
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
